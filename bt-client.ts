...
const run = () => {
    ...
    const requiredOpts = {
        infoHash: 'FD2663BCB94FEE09EC048E3190557DA91F227E29', // hex string or Buffer
        peerId: Buffer.from('01234567890123456789'), // hex string or Buffer
        announce: [ 'http://www.randomsequence.net:9987/announce' ], // list of tracker server urls
        port: 6682 // torrent client port, (in browser, optional)
    }
    ...
    client.on('warning', function (err: any) {
    ...
    client.once('peer', function (addr: any) {
