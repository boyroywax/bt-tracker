...
const requiredOpts = {
    infoHash: Buffer.from('012345678901234567890'), // hex string or Buffer
    peerId: Buffer.from('01234567890123456789'), // hex string or Buffer
    announce: [ 'http://www.randomsequence.net:9987/' ], // list of tracker server urls
    port: 9987 // torrent client port, (in browser, optional)
}
